...
def prott5_predict(annotations, query_file, indices, graph, add_graph,
                 prott5_results, output_baseline, keep_self_hits=False):
    ...
    return
# TODO: low sequence similarity, high embedding similarity
